            ...
            <div class="sections">
                <section class="main step0">
                    <div class="main-container">
                          ...
                          <div class="slide slide_1 active">
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <p>Tulemme luoksesi ja pesemme autosi ympäristöystävällisesti</p>
                          ...
                          <div class="slide slide_2">
                              <div class="row">
                                  ...
                                  <div class="row">
                                      ...
                                      <p>Käytä aikaasi fiksummin ja vapauta päivästäsi aikaa johonkin muuhun</p>
                          ...
                          <div class="slide slide_3">
                              <div class="row">
                                  ...
                                  <div class="row">
                                      ...
                                      <p>98% pienempi vedenkulutus pesukatuun verrattuna. Olemme markkinoiden ympäristöystävällin autopesu.</p>
                          ...
                          <div class="slide slide_4">
                              <div class="row">
                                  ...
                                  <div class="row">
                                      ...
                                      <p>Kaikki supersankarit eivät aina pidä viittaa päällä.</p>
                        ...
                        <div class="btns">
                            ...
                            <a href="/login/">minulla on jo käyttäjätili</a>
                        </div>
                 ...
                 <div class="map-symbol">
                        <div class="header">
                            ...
                            <ul class="menu menu1" style="border-bottom: 1px solid rgba(0,0,0,.2);">
                              <li class="menu-item menu-item-login"><a href="/login">Kirjaudu sisään</a></li>
                              ...
                              <li class="menu-item"><a href="https://upwash.fi" target="_blank">Tietoa meistä</a></li>
                            ...
                            <div class="menu-item__add1">
                                ...
                                <ul class="menu_addon1">
                                    ...
                                    <li>
                                        <label>
                                            <div class="toggle_credit" onclick="document.querySelector('.credit-card-inputs').classList.add('active')">Lisää pankki-/luottokortti</div>
                ...
                <section class="step3" v-bind:class="{ section_active: step >= 3} ">
                    ...
                    <fieldset class="step3-container">
                          ...
                          <label class="tooltip step5-action" v-if="mainType == 'Sisäpesu' ||  mainType == 'Renkaat'" for="sisapesu__1">
                            <input type="radio" v-model="pesu" name="washtype" value="sisapesu__1" id="sisapesu__1" type="radio" name="washtype" v-bind:class="{action_active: sisapesu__1}" v-on:click="setActive(3, {!! $prices->sis1 !!}, {!! $prices->sis1_time !!})" onclick="toggle__visibility(this);">
                              <h4>Perus sisäpesu  (suht. Puhtaat autot) Kesto: max 1h  
                          ...
                          <label class="tooltip step5-action" v-if="mainType == 'Sisäpesu' || mainType == 'Renkaat'" for="sisapesu__2">
                             <input type="radio" v-model="pesu" name="washtype" value="sisapesu__2" id="sisapesu__2" type="radio" name="washtype" v-if="mainType == 'Sisäpesu'" v-bind:class="{action_active: sisapesu__2}" v-on:click="setActive(2, {!! $prices->sis2 !!}, {!! $prices->sis2_time !!})"  onclick="toggle__visibility(this);">
                              <h4>Sisäpesu premium Kesto: max 2,5h 
                                      <span class="tooltiptext">
                                          <ul>
                                              <li>
                                                <b>·</b> Imurointi
                                              ...
                                              <li>
                                                <b>·</b> Penkkien pesu (5 penkkiä)
                                              </li>
                                              <li>
                                                <b>·</b> Pintojen pesu (ei pienimpiä rakoja) 
                                              </li>
                                              <li>
                                                <b>·</b> Ikkunoiden pesu
                                              </li>
                          ...
                          <label class="tooltip step5-action" v-if="mainType == 'Sisäpesu' || mainType == 'Renkaat'" for="sisapesu__3" >
                                 <input type="radio" v-model="pesu" name="washtype" value="sisapesu__3" id="sisapesu__3" type="radio" name="washtype" v-if="mainType == 'Sisäpesu'" v-bind:class="{action_active: sisapesu__3}" v-on:click="setActive(3, {!! $prices->sis3 !!}, {!! $prices->sis3_time !!})"  onclick="toggle__visibility(this); add_lux();">
                                 <script>
                                     function add_lux() {
                              ...
                              <h4>Luksus sisäpesu Kesto: max 4h 
                                      <span class="tooltiptext">
                                           <ul>
                                              <li>
                                                <b>·</b> Imurointi 
                        ...
                        <label class="tooltip step5-action" v-if="mainType == 'Molemmat' ||  mainType == 'Renkaat'" for="molemmat__1">
                            <input type="radio" v-model="pesu" name="washtype" value="molemmat__1" id="molemmat__1" v-bind:class="{action_active: molemmat__1}" v-on:click="setActive(1, {!! $prices->mol1 !!}, {!! $prices->mol1_time !!})" onclick="toggle__visibility(this);">
                              <h4>Perus Sisäpesu + Ulkopesu Kesto: max 1,5h
                                      <span class="tooltiptext">
                                          <li>
                                            <b>·</b> Ulkopesu 
                                          </li>
                ...
                <section class="step4" v-bind:class="{ section_active: step >= 4} ">
                    <div class="step4-container">
                        ...
                        <div class="step4-action" onclick="this.classList.toggle('action_active'); document.querySelector('#rb6').click();" v-if="pesu == 'sisapesu__2' || pesu == 'sisapesu__3' || pesu == 'molemmat__2' || pesu == 'molemmat__3'">
                          <span>Ilmastoinnin puhdistaminen höyryllä {{ $prices->step5_6 }}€</span>
                        ...
                        <div class="step4-action" onclick="this.classList.toggle('action_active'); document.querySelector('#rb7').click();" v-if="pesu == 'ulk__active1' || pesu == 'molemmat__1' || pesu == 'molemmat__2'">
                          <span>Hyönteisten poisto {{ $prices->step5_7 }}€</span>
...
<div class="step5-buttons">
                            <div class="step5-button" v-on:click="go()" v-if="isTime != 0" id="step6_go" onclick="open5();selection();">Jatka eteenpäin</div>
                        </div>
                </section>
                    ...
                    <div class="step7-new-container">
                        ...
                        <div class="step7-row" style="padding:26px; box-sizing: border-box">
                            ...
                            <ul class="final-ul">
                                ...
                                <li v-if="pesu == 'sisapesu__1'">Perus sisäpesu  (suht. Puhtaat autot) Kesto: max 1h  <!-- <span>@{{ sis1+price5 }}€</span> --></li>
                                <li v-if="pesu == 'sisapesu__2'">Sisäpesu premium Kesto: max 2,5h  <!-- <span>@{{ sis2+price5 }}€</li> -->
                                <li v-if="pesu == 'sisapesu__3'">Luksus sisäpesu Kesto: max 4h  <!-- <span>@{{ sis3+price5 }}€</span> --></li>

                                <li v-if="pesu == 'molemmat__1'">Perus Sisäpesu + Ulkopesu Kesto: max 1,5h <!-- <span>@{{ mol1+price5 }}€</span> --></li>
                                ...
                                <li v-if="checked6">Ilmastoinnin puhdistaminen höyryllä <!-- <span>{!! $prices->step5_6 !!} €</span> --> </li>
                                <li v-if="checked7">Hyönteisten poisto <!-- <span>{!! $prices->step5_7 !!} €</span> --></li>
        ...
        <div class="modal step7-input" style="height: auto;">
            <fieldset>
                ...
                <input type="text" name="interval" placeholder="Haluttu pesuväli: (esim. kerran kuukaudessa)"
                      >
                <input type="text" name="where" placeholder="Sisäpesut, ulkopesut vaiko molemmat?">
...
<script>
    ...
    function google__field_btn_f() { 
        if(google__field_btn.classList.contains("active")) {
            ...
            google__field_btn.innerHTML = '<div class="row"><input type="text" name="cupon" v-model="cupon" placeholder="Syötä alennuskuponki" id="coupon"></div>';
    ...
    function crossFunction() {
        google__field_btn.addEventListener("click", google__field_btn_f);
        google__field_btn.innerHTML = "Syötä kampanjakoodi";
...
<script>
    function set5() {
        var google__field_btn = document.querySelector('.google__field_btn');
        google__field_btn.innerHTML = "Syötä autosi rekisterinumero ja -tyyppi";
        google__field_btn.classList.remove("coupon__active");
        google__field_btn.classList.remove("active");
